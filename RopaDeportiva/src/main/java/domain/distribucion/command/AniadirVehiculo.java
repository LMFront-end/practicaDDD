...
public class AniadirVehiculo extends Command
{
    ...
    public AniadirVehiculo(VehiculoId vehiculoId, EstadoVehiculo estadoVehiculo, Placa placa, TipoVehiculo tipoVehiculo) {
